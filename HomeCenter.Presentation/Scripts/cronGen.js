...
(function ($) {
    ...
    $.fn.extend({
        cronGen: function () {
            ...
            var mainDiv = $("<div/>", { id: "CronGenMainDiv", style: "width:520px;height:270px;" });
            ...
            // Add an input
            var $i = $("<input>", { type: 'text', placeholder: 'Cron expression', readonly: 'readonly' }).addClass("form-control").val($(that).val());
            $i.appendTo($g);
            // Add the button
            var $b = $("<button class=\"btn btn-default\"><i class=\"glyphicon glyphicon-tasks\"></i></button>");
            ...
            $b.popover({
                ...
                template: '<div class="popover" style="max-width:550px !important; width:550px"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div></div>',
                placement: 'bottom'
